...
extern const char* AutonomousStringCopy_Express(const char* string);
...
extern "C" {
    ...
    void UnionPlatform_ExpressAd_SetDislikeListener(ExpressAd_DislikeClose dislikeClose,
                                                    int context) {
    ...
    void UnionPlatform_ExpressAdView_Dispose(void* expressAdViewPtr) {
        dispatch_async(dispatch_get_main_queue(), ^{
            (__bridge_transfer BUNativeExpressAdView*)expressAdViewPtr;
        });
    }
