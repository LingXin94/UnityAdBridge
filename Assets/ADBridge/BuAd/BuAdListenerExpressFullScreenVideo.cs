...
{
    internal class BuAdListenerExpressFullScreenVideo : IFullScreenVideoAdListener, IFullScreenVideoAdInteractionListener, IAdListener
    {
        ...
        private ExpressFullScreenVideoAd _fullScreenVideoAd;
        private AdUnit _adUnit;

        private bool _isShowing;

        public BuAdListenerExpressFullScreenVideo(AdNative adNative)
        {
        ...
        public void Request(AdUnit adUnit)
        {
            ...
            AdSlot adSlot = new AdSlot.Builder()
                 ...
                 .Build();
            _adNative.LoadExpressFullScreenVideoAd(adSlot, this);
        ...
        {
            BuAdBridge.Log("Interstitial OnFullScreenVideoAdLoad");
        }
