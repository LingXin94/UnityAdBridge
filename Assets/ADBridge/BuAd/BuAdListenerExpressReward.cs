...
{
    internal class BuAdListenerExpressReward : IRewardVideoAdListener, IRewardAdInteractionListener, IAdListener
    {
        ...
        private ExpressRewardVideoAd _rewardVideoAd;
        private AdUnit _adUnit;
        private bool _isShowing;

        public BuAdListenerExpressReward(AdNative adNative)
        {
        ...
        public void Request(AdUnit adUnit)
        {
            ...
            AdSlot adSlot = new AdSlot.Builder()
                     ...
                     .Build();
            _adNative.LoadExpressRewardAd(adSlot, this);
        ...
        {
            BuAdBridge.Log("Reward OnRewardVideoAdLoad");
            //_rewardVideoAd = ad;
