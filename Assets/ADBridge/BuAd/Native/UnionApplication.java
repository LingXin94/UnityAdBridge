...
public final class UnionApplication  {

    public void Init(Context context, String id, boolean debug){
        
        Log.d("[ADBridge][BuAd]", "[Native] Start Init");
        ...
        Log.d("[ADBridge][BuAd]", "[Native] Finish Init");
